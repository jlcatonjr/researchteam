...
Generated at: `2026-06-27T01:48:24Z`

**Sources:**

- CISA KEV: ok (catalog 2026.06.25, items 1629) — https://www.cisa.gov/sites/default/files/feeds/known_exploited_vulnerabilities.json
...
- `CVE-2026-12569` | PTC Windchill and FlexPLM | PTC Windchill and FlexPLM Improper Input Validation Vulnerability | added 2026-06-25 | EPSS 0.009310000, percentile 0.561180000 | CVSS 9.8 CRITICAL
- `CVE-2026-20230` | Cisco Unified Communications Manager | Cisco Unified Communications Manager Server-Side Request Forgery (SSRF) Vulnerability | added 2026-06-25 | EPSS 0.512380000, percentile 0.987950000 | CVSS 8.6 HIGH
- `CVE-2025-67038` | Lantronix EDS5000 | Lantronix EDS5000 Code Injection Vulnerability | added 2026-06-23 | EPSS 0.011310000, percentile 0.623540000 | CVSS 9.8 CRITICAL
- `CVE-2026-34910` | Ubiquiti UniFi OS | Ubiquiti UniFi OS Improper Input Validation Vulnerability | added 2026-06-23 | EPSS 0.785550000, percentile 0.995330000 | CVSS 10.0 CRITICAL
- `CVE-2026-34909` | Ubiquiti UniFi OS | Ubiquiti UniFi OS Path Traversal Vulnerability | added 2026-06-23 | EPSS 0.022690000, percentile 0.808360000 | CVSS 10.0 CRITICAL
- `CVE-2026-34908` | Ubiquiti UniFi OS | Ubiquiti UniFi OS Improper Access Control Vulnerability | added 2026-06-23 | EPSS 0.024520000, percentile 0.823410000
...
- `CVE-2026-48907` | Widget Factory Joomla Content Editor  | Widget Factory Joomla Content Editor Improper Access Control Vulnerability | added 2026-06-16 | EPSS 0.804250000, percentile 0.995710000
- `CVE-2026-54420` | LiteSpeed cPanel Plugin | LiteSpeed cPanel Plugin UNIX Symbolic Link (Symlink) Following Vulnerability | added 2026-06-15 | EPSS 0.012610000, percentile 0.659260000
- `CVE-2026-20262` | Cisco Catalyst SD-WAN Manager | Cisco Catalyst SD-WAN Manager Directory or Path Traversal Vulnerability | added 2026-06-15 | EPSS 0.076830000, percentile 0.938310000
- `CVE-2026-35273` | Oracle  PeopleSoft Enterprise PeopleTools | Oracle PeopleSoft Enterprise PeopleTools Missing Authentication for Critical Function Vulnerability | added 2026-06-12 | EPSS 0.897930000, percentile 0.997740000
...
- `CVE-2026-11645` | Google Chromium V8 | Google Chromium V8 Out-of-Bounds Read and Write Vulnerability | added 2026-06-09 | EPSS 0.016540000, percentile 0.735960000
- `CVE-2026-7473` | Arista Extensible Operating System | Arista Extensible Operating System Incomplete Comparison with Missing Factors Vulnerability | added 2026-06-09 | EPSS 0.008360000, percentile 0.530890000
- `CVE-2026-20245` | Cisco Catalyst SD-WAN Manager | Cisco Catalyst SD-WAN Manager Improper Encoding or Escaping of Output Vulnerability | added 2026-06-09 | EPSS 0.099220000, percentile 0.949920000
