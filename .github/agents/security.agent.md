...
Generated at: `2026-07-08T18:32:11Z`
...
- `CVE-2026-48908` | JoomShaper SP Page Builder | JoomShaper SP Page Builder Unrestricted Upload of File with Dangerous Type Vulnerability | added 2026-07-07 | EPSS 0.014310000, percentile 0.698350000 | CVSS 9.8 CRITICAL
- `CVE-2026-55255` | Langflow Langflow | Langflow Authorization Bypass Through User-Controlled Key Vulnerability | added 2026-07-07 | EPSS 0.004380000, percentile 0.352020000 | CVSS 8.4 HIGH
- `CVE-2026-56290` | Joomlack Page Builder | Joomlack Page Builder Improper Access Control Vulnerability | added 2026-07-07 | EPSS 0.007380000, percentile 0.500860000 | CVSS 9.8 CRITICAL
- `CVE-2026-48282` | Adobe ColdFusion | Adobe ColdFusion Path Traversal Vulnerability | added 2026-07-07 | EPSS 0.031990000, percentile 0.865930000 | CVSS 10.0 CRITICAL
- `CVE-2026-45659` | Microsoft SharePoint Server | Microsoft SharePoint Server Deserialization of Untrusted Data Vulnerability | added 2026-07-01 | EPSS 0.032190000, percentile 0.866970000 | CVSS 8.8 HIGH
- `CVE-2026-48558` | SimpleHelp  SimpleHelp | SimpleHelp Authentication Bypass Vulnerability | added 2026-06-29 | EPSS 0.011600000, percentile 0.632970000
- `CVE-2026-12569` | PTC Windchill and FlexPLM | PTC Windchill and FlexPLM Improper Input Validation Vulnerability | added 2026-06-25 | EPSS 0.012470000, percentile 0.657590000
- `CVE-2026-20230` | Cisco Unified Communications Manager | Cisco Unified Communications Manager Server-Side Request Forgery (SSRF) Vulnerability | added 2026-06-25 | EPSS 0.416940000, percentile 0.985140000
- `CVE-2025-67038` | Lantronix EDS5000 | Lantronix EDS5000 Code Injection Vulnerability | added 2026-06-23 | EPSS 0.008890000, percentile 0.550030000
...
- `CVE-2026-34909` | Ubiquiti UniFi OS | Ubiquiti UniFi OS Path Traversal Vulnerability | added 2026-06-23 | EPSS 0.022690000, percentile 0.809470000
- `CVE-2026-34908` | Ubiquiti UniFi OS | Ubiquiti UniFi OS Improper Access Control Vulnerability | added 2026-06-23 | EPSS 0.024520000, percentile 0.824440000
...
- `CVE-2026-54420` | LiteSpeed cPanel Plugin | LiteSpeed cPanel Plugin UNIX Symbolic Link (Symlink) Following Vulnerability | added 2026-06-15 | EPSS 0.012610000, percentile 0.660920000
