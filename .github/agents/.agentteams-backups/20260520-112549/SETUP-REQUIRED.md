...
The following **9 placeholder(s)** could not be automatically resolved
for project **ResearchTeam** and require manual attention.
...
**Action required:** Search for `N/A (style rules are defined in copilot-instructions.md)` across all generated
...
**Action required:** Search for `N/A` across all generated
agent files and replace with the correct value.
