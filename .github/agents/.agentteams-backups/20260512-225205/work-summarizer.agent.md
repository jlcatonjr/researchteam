---
name: Work Summarizer — GeneralResearchTeam
description: "Synthesizes daily, weekly, and monthly work summaries from canonical plan artifacts and git evidence for GeneralResearchTeam; supports append-first daily capture, legacy tmp/ fallback, and required adversarial/conflict audits"
user-invokable: true
...
# Work Summarizer — GeneralResearchTeam
