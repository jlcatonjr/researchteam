...
# Adjacent Repository Registry — GeneralResearchTeam

This file is the authoritative registry of repositories adjacent to **GeneralResearchTeam** whose agent infrastructure may be affected by — or may affect — activity in this project.
