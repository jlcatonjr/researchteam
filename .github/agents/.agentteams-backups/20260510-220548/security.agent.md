...
Generated at: `2026-04-18T13:49:55Z`
...
- `CVE-2026-34197` | Apache ActiveMQ | Apache ActiveMQ Improper Input Validation Vulnerability | added 2026-04-16 | EPSS 0.466380000, percentile 0.976680000 | CVSS 8.8 HIGH
- `CVE-2009-0238` | Microsoft Office | Microsoft Office Remote Code Execution | added 2026-04-14 | EPSS 0.811420000, percentile 0.991620000 | CVSS 8.8 HIGH
- `CVE-2026-32201` | Microsoft SharePoint Server | Microsoft SharePoint Server Improper Input Validation Vulnerability | added 2026-04-14 | EPSS 0.008080000, percentile 0.742450000 | CVSS 6.5 MEDIUM
- `CVE-2012-1854` | Microsoft Visual Basic for Applications (VBA) | Microsoft Visual Basic for Applications Insecure Library Loading Vulnerability | added 2026-04-13 | EPSS 0.100700000, percentile 0.930970000 | CVSS 7.8 HIGH
- `CVE-2025-60710` | Microsoft Windows | Microsoft Windows Link Following Vulnerability | added 2026-04-13 | EPSS 0.179690000, percentile 0.951630000 | CVSS 7.8 HIGH
- `CVE-2023-21529` | Microsoft Exchange Server | Microsoft Exchange Server Deserialization of Untrusted Data Vulnerability | added 2026-04-13 | EPSS 0.350170000, percentile 0.970370000
- `CVE-2023-36424` | Microsoft Windows | Microsoft Windows Out-of-Bounds Read Vulnerability | added 2026-04-13 | EPSS 0.055450000, percentile 0.902840000
- `CVE-2020-9715` | Adobe Acrobat | Adobe Acrobat Use-After-Free Vulnerability | added 2026-04-13 | EPSS 0.758630000, percentile 0.989130000
- `CVE-2026-21643` | Fortinet FortiClient EMS | Fortinet FortiClient EMS SQL Injection Vulnerability | added 2026-04-13 | EPSS 0.339070000, percentile 0.969690000
- `CVE-2026-34621` | Adobe Acrobat and Reader | Adobe Acrobat and Reader Prototype Pollution Vulnerability | added 2026-04-13 | EPSS 0.045580000, percentile 0.892120000
- `CVE-2026-1340` | Ivanti Endpoint Manager Mobile (EPMM) | Ivanti Endpoint Manager Mobile (EPMM) Code Injection Vulnerability | added 2026-04-08 | EPSS 0.758160000, percentile 0.989110000
- `CVE-2026-35616` | Fortinet FortiClient EMS | Fortinet FortiClient EMS Improper Access Control Vulnerability | added 2026-04-06 | EPSS 0.252550000, percentile 0.962040000
- `CVE-2026-3502` | TrueConf Client | TrueConf Client Download of Code Without Integrity Check Vulnerability | added 2026-04-02 | EPSS 0.014810000, percentile 0.810320000
- `CVE-2026-5281` | Google Dawn | Google Dawn Use-After-Free Vulnerability | added 2026-04-01 | EPSS 0.032780000, percentile 0.871940000
- `CVE-2026-3055` | Citrix NetScaler | Citrix NetScaler Out-of-Bounds Read Vulnerability | added 2026-03-30 | EPSS 0.557080000, percentile 0.980950000
