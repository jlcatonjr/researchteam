---
name: Conflict Resolution — GeneralResearchTeam
description: "Makes ACCEPT/REJECT/REVISE decisions on conflicts flagged by the conflict auditor in GeneralResearchTeam"
...
# Conflict Resolution — GeneralResearchTeam
