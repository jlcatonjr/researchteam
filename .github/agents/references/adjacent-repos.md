...
# Adjacent Repository Registry — ResearchTeam

This file is the authoritative registry of repositories adjacent to **ResearchTeam** whose agent infrastructure may be affected by — or may affect — activity in this project.
