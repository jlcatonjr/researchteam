...
graph TD
	...
	OOT --> DT[Downfall Timeline]
	OOT --> CT[Child Timeline]
	OOT --> AT[Adult Timeline]

	DT --> ALTTP[A Link to the Past]
	ALTTP --> OOA[Oracle Games]
	OOA --> LA[Link's Awakening]
	LA --> ALBW[A Link Between Worlds]
	ALBW --> TFH[Tri Force Heroes]
	TFH --> LOZ[The Legend of Zelda]
	LOZ --> AOL[Adventure of Link]

	CT --> MM[Majora's Mask]
	MM --> TP[Twilight Princess]
	TP --> FSA[Four Swords Adventures]

	AT --> TWW[The Wind Waker]
	TWW --> PH[Phantom Hourglass]
	PH --> ST[Spirit Tracks]

	AOL --> FH[Far-future horizon\nbranch-agnostic]
	FSA --> FH
	ST --> FH
	FH --> BOTW[Breath of the Wild]
	BOTW --> TOTK[Tears of the Kingdom]
```
