...
source: .github/agents/reference-manager.agent.md
source_sha256: 6ab0e3a7ef89f611e5d2a9ca452708d3bc936618526640dcbc586e8ddfe464b6
...
This is a Claude subagent stub. The canonical agent definition lives at:
    ...
    .github/agents/reference-manager.agent.md
...
- Source role: Manages the bibliography and reference database for ResearchTeam — strict citation verification, anti-fabrication enforcement, and fail-closed integrity gates
