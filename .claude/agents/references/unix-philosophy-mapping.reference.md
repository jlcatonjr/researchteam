...
# Unix Philosophy — Code Hygiene Mapping (ResearchTeam)
...
|------|------|-----------|
| **CH-03** — No Ad-Hoc Scripts in `Projects/` | 2 | Source code contains only intentional, production-focused logic. Project-specific need for clean source boundaries. |
